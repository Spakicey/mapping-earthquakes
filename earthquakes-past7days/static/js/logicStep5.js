...
// Create the earthquake layer for our mao
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
    ...
    // Determines the color of the circle based on magnitude
    ...
    legend.onAdd = function() {
        ...
        // Loop through interals to generate a label with a colored square
